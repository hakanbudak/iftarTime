                ...
                <SimpleCard className="relative overflow-visible text-center !p-10 border-t-8 border-primary-500">
                    ...
                    <div className="flex flex-col items-center z-10 relative">
                        ...
                        <div className="mt-4 sm:mt-6 px-2">
                            <p className="text-[10px] sm:text-xs text-gray-400 text-center leading-relaxed flex items-center justify-center gap-1">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="hidden sm:block w-4 h-4 text-primary-400">
                                    <path fillRule="evenodd" d="M16.403 12.652a3 3 0 0 0 0-5.304 3 3 0 0 0-3.75-3.751 3 3 0 0 0-5.305 0 3 3 0 0 0-3.751 3.75 3 3 0 0 0 0 5.305 3 3 0 0 0 3.75 3.751 3 3 0 0 0 5.305 0 3 3 0 0 0 3.751-3.75Zm-2.546-4.46a.75.75 0 0 0-1.214-.883l-3.483 4.79-1.88-1.88a.75.75 0 1 0-1.06 1.061l2.5 2.5a.75.75 0 0 0 1.137-.089l4-5.5Z" clipRule="evenodd" />
                                </svg>
                                <span>Vakitler Diyanet İşleri Başkanlığı verileriyle uyumludur</span>
                            </p>
                        </div>
                    </div>
                </SimpleCard>
